...
public class ScenarioResult {
   ...
   * @param sentBytes
   */
  public ScenarioResult(final String destination, final byte[] receivedBytes,
      final byte[] sentBytes) {
    this.success = true;
   ...
   * @param cause
   */
  public ScenarioResult(final String msg, final Throwable cause, final byte[] receivedBytes,
      final byte[] sentBytes) {
    this.success = false;
   ...
   * @param cause
   */
  public ScenarioResult(final String destination, final String msg, final Throwable cause,
      final Tap tap) {
    this.success = false;
    this.destination = Objects.requireNonNull(destination, "destination bytes must not be null");
    this.msg = Objects.requireNonNull(msg, "msg must not be null");
